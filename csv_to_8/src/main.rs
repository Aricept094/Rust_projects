...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    // Input directory
    let input_dir = Path::new("/home/aricept094/mydata/casia_less_than_1/combined_data/");

    // Base output directory
    let base_output_dir = Path::new("/home/aricept094/mydata/casia_less_than_1/combined_data");
